...
describe('InstanceReportingBlobService', () => {
  ...
  it('should stream CSV with header and data rows for registrations and transactions', async () => {
    ...
    expect(registrationsCsv).toBe(
      'instance,version,programTitle,programId,status,referenceId,createdDate,preferredLanguage,fspName,paymentAmountMultiplier,maxPayments,duplicateStatus,uploadDate\n' +
        'a,1,P1,1,included,ref-1,2026-04-19T00:00:00.000Z,en,Safaricom,1,3,unique,2026-04-20\n',
    );
